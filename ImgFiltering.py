...
img = Image.open("E:\Hammad MHSSCOE\SEM6 - EXTC\IPMV\cheeetah.jpg")
...
def CHANGE_TO_GREEN_COLOUR_PLANE(img):
    img = cv2.imread('E:\Hammad MHSSCOE\SEM6 - EXTC\IPMV\cheeetah.jpg', 1) 
    plt.imshow(img) 
    print('Given image:')
    plt.show() 
...
def APPLY_HIGH_PASS_FILTERING(img):
    img = cv2.imread('E:\Hammad MHSSCOE\SEM6 - EXTC\IPMV\cheeetah.jpg') 
    plt.imshow(img) 
    print('Given image:')
    plt.show()  
